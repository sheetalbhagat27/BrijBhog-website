...
// //   { label: "Home", path: "/" },
// //   { label: "Services", path: "/services" },
// //   { label: "Venues", path: "/venues", hasDropdown: true }, // ⭐ New Venue link
// //   { label: "About Us", path: "/about" },
// //   { label: "Contact", path: "/contact" },
// // ];
...
// //                 {link.hasDropdown && (
// //                   <ChevronDown 
// //                     className={`h-4 w-4 transition-transform ${venueOpen ? "rotate-180" : ""}`} 
// //                   />
// //                 )}
// //               </Link>

// //               {/* Venue Dropdown - Desktop */}
...
// //                       className="w-full text-left px-6 py-3 font-body text-sm hover:bg-primary/5 hover:text-primary transition-all text-muted-foreground"
// //                     >
// //                       {venue.label}
// //                     </button>
// //                   ))}
...
// //                         key={venue.slug}
// //                         onClick={() => handleVenueSelect(venue.slug)}
// //                         className="w-full text-left py-2 font-body text-sm hover:bg-primary/5 hover:text-primary transition-all text-muted-foreground"
// //                       >
// //                         • {venue.label}
// //                       </button>
// //                     ))}
